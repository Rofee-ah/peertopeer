...
export const MarkListingSold = ({ isOpen, onClose, onMarkAsSold, listing }) => {
    // Prevent scrolling on body when modal is open
    const [entity, setEntity] = useState()

    useEffect(() => {
        if (listing) setEntity(listing)
        if (isOpen) {
    ...
    const handleSubmit = () => {
        const updatedEntity = { ...entity, status: "sold" };
        setEntity(updatedEntity);
        onMarkAsSold(updatedEntity);
        onClose()
    }
            ...
            >
                ...
                >
                    ...
                    <div className="flex justify-between items-start mb-6">
                        <h2 className="text-2xl font-bold text-gray-900">Mark {listing?.title} as sold?</h2>
                        <button
                            onClick={onClose}
                    ...
                    <div className="flex flex-col items-center text-center mb-8 mt-2">
                        ...
                        <p className="text-gray-500 text-[15px] leading-relaxed max-w-[300px]">
                            Are you sure you want to mark <span className="font-bold text-gray-900">"{listing?.title}"</span> as sold? This action can be reversed pending the duration period is still active.
                        </p>
                    </div>
                    ...
                    <div className="flex gap-4 w-full">
                        ...
                        <button
                            ...
                            // onClick={() => {
                            //     if (onMarkAsSold) onMarkAsSold(listing);
                            //     else onClose();
                            // }}
