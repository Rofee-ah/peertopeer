        ...
        <div className='space-y-6'>
          ...
          <div>
            <label className='block font-semibold mb-2'>
              Business Nameeeeeeeeeee (Optional)
            </label>

            <div className='flex items-center bg-[#e9eaec] rounded-xl px-4 py-3 shadow-[inset_6px_6px_12px_rgba(0,0,0,0.15),inset_-6px_-6px_12px_rgba(255,255,255,0.9)]'>
          ...
          <div>
            ...
            <select className='w-full bg-[#e9eaec] rounded-xl px-4 py-3 outline-none shadow-[10px_10px_30px_rgba(0,0,0,0.12),-10px_-10px_30px_rgba(255,255,255,0.9)]'>
          ...
          <div>
            ...
            <textarea
              ...
              className='w-full bg-[#e9eaec] rounded-xl p-4 outline-none h-32 resize-none shadow-[inset_6px_6px_12px_rgba(0,0,0,0.15),inset_-6px_-6px_12px_rgba(255,255,255,0.9)]'
            />
          </div>
