...
export default function page() {
  ...
  useEffect(() => {
    if (vendor) router.push("/VendorProfile");
  }, [vendor]);
        ...
        <div className="p-6 md:p-10">
          ...
          <div className="flex md:flex-row gap-1">
            ...
            <a href="/VendorDetails">
              <button className="flex-1 bg-blue-600 text-white md:w-[100px]  w-[100px] rounded-full py-4 px-3 font-semibold hover:bg-blue-700 transition">
                Continue
              </button>
            </a>
          </div>
